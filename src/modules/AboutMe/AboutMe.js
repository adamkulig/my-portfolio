  ...
  return (
    <ScrollableAnchor id={'aboutme'}>
      <section className='aboutme'>
        ...
        <p>I have been learning programming for half year. I am a systematic, precise, ambitious person who can not leave an unresolved problem. I think that I already have the basics to take the first job as a frontend developer.</p> 
