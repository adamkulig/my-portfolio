    ...
    <ScrollableAnchor id={'aboutme'}>
      <section className='aboutme'>
        ...
        <div className='aboutme__text'>
          ...
          <p>I have been learning programming for half year. I take part in the programming course on the Front-end Development with React specialization. </p>
          <p>I am a systematic, precise, ambitious person who can not leave an unresolved problem.</p> 
